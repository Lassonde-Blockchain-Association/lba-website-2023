...
const Footer = () => {
  return (
    <div
      id="footer"
      className="z-50 md:h-[80vh] h-[100vh] h-auto overflow-hidden text-white flex-col flex justify-end shrink-0"
    >
      ...
      <div className="md:h-3/6 inset-x-0">
        ...
        <div className="md:flex md:justify-center grid grid-cols-2 grid-rows-2 w-full border-solid border-white border-t-8 md:border-b-8 md:h-2/5 items-center ">
