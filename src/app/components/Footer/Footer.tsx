...
const Footer = () => {
  return (
    <div
      id="footer"
      className="bg-black md:h-[80vh] h-[100vh] overflow-hidden text-white flex-col flex justify-end"
    >
      ...
      <div className="md:h-3/6 inset-x-0">
        ...
        <div className="md:flex md:justify-center grid grid-cols-2 grid-rows-2 w-full border-solid border-white border-t-8 md:border-b-8 md:h-2/6 items-center ">
